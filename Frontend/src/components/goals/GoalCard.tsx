        ...
        <div className="space-y-4">
          ...
          <div className="text-sm text-gray-500">
            ...
            <div className="mt-2 space-x-2">
              {type === 'total_calories' && (
                <>
                  <button onClick={() => setGoalValue("2000")} className="text-blue-500 hover:text-blue-600">2,000</button>
                  <button onClick={() => setGoalValue("2500")} className="text-blue-500 hover:text-blue-600">2,500</button>
                  <button onClick={() => setGoalValue("3000")} className="text-blue-500 hover:text-blue-600">3,000</button>
                </>
              )}
              {type === 'total_protein' && (
                <>
                  <button onClick={() => setGoalValue("100")} className="text-blue-500 hover:text-blue-600">100g</button>
                  <button onClick={() => setGoalValue("150")} className="text-blue-500 hover:text-blue-600">150g</button>
                  <button onClick={() => setGoalValue("200")} className="text-blue-500 hover:text-blue-600">200g</button>
                </>
              )}
              {type === 'total_water_intake' && (
                <>
                  <button onClick={() => setGoalValue("2")} className="text-blue-500 hover:text-blue-600">2L</button>
                  <button onClick={() => setGoalValue("2.5")} className="text-blue-500 hover:text-blue-600">2.5L</button>
                  <button onClick={() => setGoalValue("3")} className="text-blue-500 hover:text-blue-600">3L</button>
                </>
              )}
            </div>
          </div>
